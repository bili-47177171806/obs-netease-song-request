# -*- coding: utf-8 -*-
"""挖 syncCurPlayingListToNative / addItemToCurPlayingList / replaceCurPlayingList 实现。"""
import sys
import json
...
def main():
    ...
    for kw, maxh, back, fwd in [
        ("syncCurPlayingListToNative", 3, 200, 1100),
        ("addItemToCurPlayingList", 3, 200, 900),
        ("replaceCurPlayingList", 2, 150, 700),
    ]:
        r = c.evaluate(r"""
(async () => {
